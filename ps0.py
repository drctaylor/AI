...
img1 = cv2.imread("input/Woman.png",1)
...
img2 = cv2.imread("input/Firefly.png",1)
...
#######################################
# Step 3: Replacement of pixels (Note: For this, use the better channel from 
#       2-b/2-c as monochrome versions.)
...
# What is the mean? What is the standard deviation?  And how did you compute these?
...
cv2.imwrite("output/ps0-4-c-2.png", shifted_green)
